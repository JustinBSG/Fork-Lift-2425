...
#define FL_MOTOR_CCR FL_MOTOR_TIMER->CCR1
#define FR_MOTOR_CCR FR_MOTOR_TIMER->CCR3
#define RL_MOTOR_CCR RL_MOTOR_TIMER->CCR2
#define RR_MOTOR_CCR RR_MOTOR_TIMER->CCR4
