...
#define ROBOT_MAX_X_VELOCITY 7.4625 * 0.3   // max linear velocity of the robot, in m/s
#define ROBOT_MAX_Y_VELOCITY 7.4625 * 0.3   // max linear velocity of the robot, in m/s
