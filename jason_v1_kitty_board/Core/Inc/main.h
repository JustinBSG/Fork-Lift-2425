...
#define MOTOR_RL_IN1_Pin GPIO_PIN_4
#define MOTOR_RL_IN1_GPIO_Port GPIOE
#define MOTOR_RL_IN2_Pin GPIO_PIN_5
#define MOTOR_RL_IN2_GPIO_Port GPIOE
#define MOTOR_FL_IN2_Pin GPIO_PIN_6
#define MOTOR_FL_IN2_GPIO_Port GPIOE
#define RL_PWM_Pin GPIO_PIN_5
#define RL_PWM_GPIO_Port GPIOA
#define MOTOR_FL_IN1_Pin GPIO_PIN_0
...
#define MOTOR_RR_IN1_Pin GPIO_PIN_15
#define MOTOR_RR_IN1_GPIO_Port GPIOA
#define MOTOR_FR_IN2_Pin GPIO_PIN_12
#define MOTOR_FR_IN2_GPIO_Port GPIOC
#define MOTOR_FR_IN1_Pin GPIO_PIN_0
#define MOTOR_FR_IN1_GPIO_Port GPIOD
