...
#define SERVO_ID1_MAX_POS 500 + 362
#define SERVO_ID1_MIN_POS 500 - 400
#define SERVO_ID2_MAX_POS 500 + 373
#define SERVO_ID2_MIN_POS 500 - 390
#define SERVO_ID3_MAX_POS 500 + 364
#define SERVO_ID3_MIN_POS 500 - 390
#define SERVO_ID4_MAX_POS 500 + 370
...
#define SERVO_ID6_MIN_POS 500 - 120
...
#define SERVO_ID6_ANGLE_TO_POS(angle) \
  ((angle) > 0                        \
     ? INITIAL_POS                    \
     : INITIAL_POS - angle / 30.0 * (INITIAL_POS - SERVO_ID6_MIN_POS))
...
#define SERVO_ID6_POS_TO_ANGLE(pos) \
  ((pos) > INITIAL_POS              \
     ? 0                            \
     : (INITIAL_POS - (pos)) * -30.0 / (INITIAL_POS - SERVO_ID6_MIN_POS))
