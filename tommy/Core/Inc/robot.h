...
#define ROBOT_MAX_X_VELOCITY 7.4625 * 0.75 // max linear velocity of the robot, in m/s
#define ROBOT_MAX_Y_VELOCITY 7.4625 * 0.75 // max linear velocity of the robot, in m/s
#define ROBOT_MAX_Z_VELOCITY 72.1100 / 10 * 0.75 // max angular velocity of the robot, in rad/s
