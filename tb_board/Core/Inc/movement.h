...
#define FR_MOTOR_B_TIMER TIM9
#define RL_MOTOR_A_TIMER TIM1
#define RL_MOTOR_B_TIMER TIM1
#define RR_MOTOR_A_TIMER TIM1
#define RR_MOTOR_B_TIMER TIM1

#define FL_MOTOR_A_ARR FL_MOTOR_A_TIMER->ARR
#define FL_MOTOR_B_ARR FL_MOTOR_B_TIMER->ARR
#define FR_MOTOR_A_ARR FR_MOTOR_A_TIMER->ARR
#define FR_MOTOR_B_ARR FR_MOTOR_B_TIMER->ARR
#define RL_MOTOR_A_ARR RL_MOTOR_A_TIMER->ARR
#define RL_MOTOR_B_ARR RL_MOTOR_B_TIMER->ARR
#define RR_MOTOR_A_ARR RR_MOTOR_A_TIMER->ARR
#define RR_MOTOR_B_ARR RR_MOTOR_B_TIMER->ARR

#define FL_MOTOR_A_CCR FL_MOTOR_A_TIMER->CCR1
#define FL_MOTOR_B_CCR FL_MOTOR_B_TIMER->CCR1
#define FR_MOTOR_A_CCR FR_MOTOR_A_TIMER->CCR1
#define FR_MOTOR_B_CCR FR_MOTOR_B_TIMER->CCR2
#define RL_MOTOR_A_CCR RL_MOTOR_A_TIMER->CCR1
#define RL_MOTOR_B_CCR RL_MOTOR_B_TIMER->CCR2
